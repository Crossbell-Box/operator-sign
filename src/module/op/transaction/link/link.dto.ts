...
export class LinkCharacterParam extends CharacterIdParam {
  @ApiProperty({
    description:
      'Target character ID Or address string if the target character is not created yet',
  })
  toCharacterIdOrToAddress!: number | `0x${string}`;
...
export class UnlinkCharacterParam extends CharacterIdParam {
...
export class LinkNoteParam extends CharacterIdParam {
  @ApiProperty({ description: 'Target character ID' })
  @IsInt()
  toCharacterId!: number;
...
export class UnlinkNoteParam extends CharacterIdParam {
  @ApiProperty({ description: 'Target character ID' })
  @IsInt()
  toCharacterId!: number;
